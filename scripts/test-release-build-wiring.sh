...
require_source 'verify-stable-release-signature.sh' \
    "build.sh does not validate Developer ID output"
require_source 'publishable through the matching Homebrew contract' \
    "build.sh does not explain the supported ad-hoc publication path"
