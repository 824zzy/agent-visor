...
KEY_ACCOUNT="com.824zzy.AgentVisor"
...
POSSIBLE_PATHS=(
    "${AV_DERIVED:-/tmp/av-debug-build}/SourcePackages/artifacts/sparkle/Sparkle/bin/generate_keys"
    "${AV_RELEASE_DERIVED:-/tmp/av-release-build}/SourcePackages/artifacts/sparkle/Sparkle/bin/generate_keys"
    "$HOME/Library/Developer/Xcode/DerivedData/AgentVisor-*/SourcePackages/artifacts/sparkle/Sparkle/bin/generate_keys"
...
PUBLIC_KEY=$(
    "$GENERATE_KEYS" --account "$KEY_ACCOUNT" |
...
echo "3. Run ./scripts/create-release.sh to create a signed ZIP and appcast"
